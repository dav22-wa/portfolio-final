  ...
  return (
    <section id="skills" className="py-[60px] lg:py-[100px] w-full bg-[#111318]">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        >
          {/* Card 1 */}
          <motion.div variants={item} className="bg-[#1a1d24] p-8 lg:p-10 border border-[#2a2d35] border-t-2 border-t-[#2a2d35] hover:border-t-brand-gold transition-all duration-300 transform hover:-translate-y-2 flex flex-col text-left">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">AI & Machine Learning</span>
            ...
            <a href="#projects" className="text-brand-gold font-bold tracking-widest flex items-center hover:text-yellow-400 transition-colors uppercase text-sm mt-auto">
          ...
          {/* Card 2 */}
          <motion.div variants={item} className="bg-[#1a1d24] p-8 lg:p-10 border border-[#2a2d35] border-t-2 border-t-[#2a2d35] hover:border-t-brand-gold transition-all duration-300 transform hover:-translate-y-2 flex flex-col text-left">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">Web Development</span>
          ...
          {/* Card 3 */}
          <motion.div variants={item} className="bg-[#1a1d24] p-8 lg:p-10 border border-[#2a2d35] border-t-2 border-t-[#2a2d35] hover:border-t-brand-gold transition-all duration-300 transform hover:-translate-y-2 flex flex-col text-left">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-4 block">Cybersecurity</span>
            ...
            <a href="#about" className="text-brand-gold font-bold tracking-widest flex items-center hover:text-yellow-400 transition-colors uppercase text-sm mt-auto">
